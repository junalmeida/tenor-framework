...
namespace Tenor.Data
{
    public abstract partial class EntityBase
    {
        ...
        public static EntityBase[] Search(SearchOptions searchOptions)
        {
        ...
        /// <returns>An array of entities.</returns>
        [Obsolete("Use SearchOptions.Execute instead.")]
        public static EntityBase[] Search(SearchOptions searchOptions, ConnectionStringSettings connection)
        {
            if (searchOptions == null)
                throw new ArgumentNullException("searchOptions");
        ...
        public static EntityBase[] Search(SearchOptions searchOptions, int page, int pageSize, ConnectionStringSettings connection)
        {
            if (searchOptions == null)
                throw new ArgumentNullException("searchOptions");
        ...
        private static void SetFindDefinitions<t>(string[] PropertyExpression, object[] Value, Tenor.Data.CompareOperator[] @Operator, Tenor.Data.LogicalOperator[] Logical) where t : EntityBase
        {
            //TODO: Consider coding an anonymous delegate.
            EntityList<t>._findProp = PropertyExpression;
            EntityList<t>._findValue = Value;
            EntityList<t>._findOperator = @Operator;
            EntityList<t>._findLogical = Logical;
        }
        ...
        public static T Find<T>(T[] items, string propertyExpression, object value) where T : EntityBase
        {
        ...
        /// <returns>The first found object.</returns>
        public static T Find<T>(T[] items, string propertyExpression, object value, Tenor.Data.CompareOperator compareOperator) where T : EntityBase
        {
            SetFindDefinitions<T>(propertyExpression, value, compareOperator);
            return Array.Find<T>(items, new Predicate<T>(EntityList<T>.FindDelegate));
        }
        ...
        public static T[] FindAll<T>(T[] items, string propertyExpression, object value) where T : EntityBase
        {
        ...
        /// <param name="compareOperator">The compare operator to use against the property.</param>
        /// <returns>An array of objects.</returns>
        public static T[] FindAll<T>(T[] items, string propertyExpression, object value, Tenor.Data.CompareOperator compareOperator) where T : EntityBase
        {
            SetFindDefinitions<T>(propertyExpression, value, compareOperator);
            return Array.FindAll<T>(items, new Predicate<T>(EntityList<T>.FindDelegate));
        }
        ...
        /// <returns>An array of objects.</returns>
        public static T[] FindAll<T>(T[] items, string[] propertyExpressions, object[] values, Tenor.Data.CompareOperator[] compareOperators, Tenor.Data.LogicalOperator[] logicalOperators) where T : EntityBase
        {
        ...
        public static T FindLast<T>(T[] items, string propertyExpression, object value) where T : EntityBase
        {
        ...
        public static int FindIndex<T>(T[] items, string propertyExpression, object value) where T : EntityBase
        {
            SetFindDefinitions<T>(propertyExpression, value, Tenor.Data.CompareOperator.Equal);
            return Array.FindIndex<T>(items, new Predicate<T>(EntityList<T>.FindDelegate));
        }
        ...
        public static int FindLastIndex<T>(T[] items, string propertyExpression, object value) where T : EntityBase
        {
            SetFindDefinitions<T>(propertyExpression, value, Tenor.Data.CompareOperator.Equal);
            return Array.FindLastIndex<T>(items, new Predicate<T>(EntityList<T>.FindDelegate));
        }
        ...
        /// <param name="value">The value desired.</param>
        /// <returns>The first found object.</returns>
        public static EntityBase Find(EntityBase[] items, string propertyExpression, object value)
        {
            return Find<EntityBase>(items, propertyExpression, value);
        }
        ...
        /// <param name="compareOperator">The compare operator to use against the property.</param>
        /// <returns>The first found object.</returns>
        public static EntityBase Find(EntityBase[] items, string propertyExpression, object value, Tenor.Data.CompareOperator compareOperator)
        {
            return Find<EntityBase>(items, propertyExpression, value, compareOperator);
        }
        ...
        /// <param name="value">The value desired.</param>
        /// <returns>An array of objects.</returns>
        public static EntityBase[] FindAll(EntityBase[] items, string propertyExpression, object value)
        {
            return FindAll<EntityBase>(items, propertyExpression, value);
        }
        ...
        /// <param name="compareOperator">The compare operator to use against the property.</param>
        /// <returns>An array of objects.</returns>
        public static EntityBase[] FindAll(EntityBase[] items, string propertyExpression, object value, Tenor.Data.CompareOperator compareOperator)
        {
            return FindAll<EntityBase>(items, propertyExpression, value, compareOperator);
        }
        ...
        /// <param name="value">The value desired.</param>
        /// <returns>The last found object.</returns>
        public static EntityBase FindLast(EntityBase[] items, string propertyExpression, object value)
        {
            return FindLast<EntityBase>(items, propertyExpression, value);
        }
        ...
        /// <param name="value">The value desired.</param>
        /// <returns>The index of the first found object.</returns>
        public static int FindIndex(EntityBase[] items, string propertyExpression, object value)
        {
            return FindIndex<EntityBase>(items, propertyExpression, value);
        }
        ...
        /// <param name="value">The value desired.</param>
        /// <returns>The index of the last found object.</returns>
        public static int FindLastIndex(EntityBase[] items, string propertyExpression, object value)
        {
            return FindLastIndex<EntityBase>(items, propertyExpression, value);
        }
        ...
        /// <param name="items">An array of entities.</param>
        /// <param name="propertyExpression">The property name used to match entities. You can use dot (.) separated properties to go down on the class.</param>
        public static void Sort(EntityBase[] items, string propertyExpression)
        {
            Array.Sort(items, new EntityBaseComparer(propertyExpression));
        }

        private class EntityBaseComparer : IComparer
        {

            private string _PropertyExpression;

            public EntityBaseComparer(string PropertyExpression)
            {
            ...
            {
                return Util.Compare(((EntityBase)x), ((EntityBase)y), _PropertyExpression);
            }
        }
        ...
        {
            EntityBase x = this;
            EntityBase y = obj as EntityBase;
