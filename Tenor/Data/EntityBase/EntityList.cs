...
namespace Tenor.Data
{
    ...
    [Serializable()]
    public class EntityList<T> : ICollection<T>, IList<T>, ICollection, IList where T : EntityBase
    {
        public int Count
        {
        ...
        {
            list.Sort(new EntityBaseComparer(propertyExpression));
        }

        private class EntityBaseComparer : IComparer<T>
        {
