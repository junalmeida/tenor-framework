	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </summary>
				/// <remarks></remarks>
				[Designer(typeof(ResizablePanelsDesigner)), ParseChildren(ChildrenAsProperties = true), PersistChildren(false)]public class ResizablePanels : CompositeControl, IPostBackDataHandler
				{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), Category("Data"), Description("Stores the position of the divider. Leave empty for automatic positioning."), DefaultValue(typeof(Orientation), "Horizontal")]public Unit DividerPosition
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), Category("Behavior"), Description("Controls how to render this control"), DefaultValue(typeof(Orientation), "Horizontal")]public Orientation Orientation
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(ResizablePanel)), TemplateInstance(TemplateInstance.Single)]public ITemplate FirstPanel
					{
						get
						{
							return _FirstPanel;
					...
					[Browsable(false)]public ResizablePanel FirstPanelContainer
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(ResizablePanel)), TemplateInstance(TemplateInstance.Single)]public ITemplate SecondPanel
					{
						get
						{
							return _SecondPanel;
					...
					[Browsable(false)]public ResizablePanel SecondPanelContainer
					{
						get
						{
					...
					[PersistenceMode(PersistenceMode.InnerProperty), Category("Style")]public Style FirstPanelStyle
					{
						get
						{
					...
					[PersistenceMode(PersistenceMode.InnerProperty), Category("Style")]public Style SecondPanelStyle
					{
						get
						{
					...
					[PersistenceMode(PersistenceMode.InnerProperty), Category("Style")]public Style DividerStyle
					{
						get
						{
