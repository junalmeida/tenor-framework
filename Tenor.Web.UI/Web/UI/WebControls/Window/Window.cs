		...
		namespace UI
		{
			namespace WebControls
			{
                ...
                public class Window : WebControl, IPostBackDataHandler, IPostBackEventHandler, INamingContainer
				{
					...
					[Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(WindowItem)), TemplateInstance(TemplateInstance.Single)]public ITemplate TitleTemplate
					{
						get
						{
					...
					[MergableProperty(false), TemplateContainer(typeof(Window)), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateInstance(TemplateInstance.Single)]public ITemplate ContentTemplate
					{
						get
						{
							return _Content;
					...
					[Browsable(false)]public Control ContentTemplateContainer
					{
						get
						{
					...
					[PersistenceMode(PersistenceMode.InnerProperty), Category("Style")]public TitleStyle TitleStyle
					{
						get
						{
							if (_TitleStyle == null)
					...
					[PersistenceMode(PersistenceMode.InnerProperty), Category("Style")]public Style ContentStyle
					{
						get
						{
					...
					#region " Properties "
					[Description("Determines if this control will postback to server."), Themeable(false), DefaultValue(false), Category("Behavior")]public virtual bool AutoPostBack
					{
						get
						{
					...
					[DefaultValue(false), Category("Behavior"), Description("Determines if the window is positioned on center.")]public bool StartOnCenter
					{
						get
						{
					...
					[Category("Behavior"), Description("Determines if the window is closed.")]public bool IsClosed
					{
						get
						{
					...
					[Category("Behavior"), DefaultValue(true), Themeable(true), Description("Determines if the window can be closed.")]public bool Closable
					{
						get
						{
					...
					[Category("Behavior"), DefaultValue(true), Themeable(true), Description("Determines if the window can be moved.")]public bool Movable
					{
						get
						{
					...
					[Category("Behavior"), DefaultValue(true), Themeable(true), Description("Determines if the window can be resized.")]public bool Resizable
					{
						get
						{
					...
					[Bindable(true), Themeable(true), Category("Appearance"), Description("The title bar text"), DefaultValue(""), Localizable(true)]public string Text
					{
						get
						{
				...
				[Browsable(false)]public class WindowItem : System.Web.UI.WebControls.WebControl, INamingContainer
				{
