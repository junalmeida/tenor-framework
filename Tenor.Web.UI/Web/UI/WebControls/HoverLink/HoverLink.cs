	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </summary>
				/// <remarks></remarks>
				[ToolboxItem(typeof(System.Web.UI.Design.WebControlToolboxItem)), ToolboxData("<{0}:HoverLink runat=\"server\" />"), ToolboxBitmapAttribute(typeof(System.Web.UI.WebControls.ImageButton), "ImageButton.bmp"), DefaultEvent("Click")]public class HoverLink : System.Web.UI.WebControls.HyperLink, IPostBackEventHandler
				{
					...
					[Themeable(true), DefaultValue(true), Category("Behavior"), Description("Indicates whether to preload images on page load")]public bool PreloadImages
					{
						get
						{
					...
					[Themeable(true), UrlProperty("*.bmp;*.gif.*.jpg;*.png"), Editor(typeof(System.Web.UI.Design.UrlEditor), typeof(System.Drawing.Design.UITypeEditor)), DefaultValue(""), Category("Appearance"), Description("The URL of the image to be shown when mouse hovers.")]public string HoverImageUrl
					{
						get
						{
