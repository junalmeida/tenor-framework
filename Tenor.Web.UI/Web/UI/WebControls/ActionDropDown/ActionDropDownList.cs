	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </summary>
				/// <remarks></remarks>
				[ToolboxItem(typeof(System.Web.UI.Design.WebControlToolboxItem)), ToolboxData("<{0}:ActionDropDownList runat=\"server\" />"), ToolboxBitmapAttribute(typeof(System.Web.UI.WebControls.DropDownList), "DropDownList.bmp")]public class ActionDropDownList : System.Web.UI.WebControls.DropDownList, IPostBackEventHandler
				{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Description("The behavior mode of the DropDownList"), Category("Behavior"), DefaultValue(typeof(ActionDropDownListMode), "AddNewItem")]public ActionDropDownListMode DropDownMode
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Description("Defines the label of the custom item"), Category("Appearance"), DefaultValue("New Label")]public string ActionLabel
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Description("Defines the text to show on the prompt"), Category("Appearance"), DefaultValue("Type below the new label")]public string ActionText
					{
						get
						{
