	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </summary>
				/// <remarks></remarks>
				[System.ComponentModel.DefaultPropertyAttribute("ImageUrl"), ToolboxData("<{0}:ReorderImageButton runat=server></{0}:ReorderImageButton>")]public class ReorderImageButton : Image
				{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[DefaultValue(typeof(Direction), "Up"), Description("Determines wich action this image button will perform"), Category("Behavior")]public Direction Direction
					{
						get
						{
					...
					[DefaultValue(""), Description("Gets or sets the client-side script that executes when a ReorderImageButton control\'s Click event is raised."), Category("Behavior")]public string OnClientClick
					{
						get
						{
