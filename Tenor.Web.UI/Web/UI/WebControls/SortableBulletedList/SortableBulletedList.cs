		...
		namespace UI
		{
			namespace WebControls
			{
                ...
                public class SortableBulletedList : System.Web.UI.WebControls.BulletedList, IPostBackDataHandler
				{
					...
					[DefaultValue(typeof(Orientation), "Vertical"), Category("Layout"), Description("Indica a orientação da lista.")]public Orientation Orientation
					{
						get
						{
					...
					[Category("Layout"), Description("Define uma classe CSS para cada item da lista.")]public string ItemCssClass
					{
						get
						{
					...
					[Category("Behavior"), Description("Define um função para ser chamada ao completar uma mudança de ordem.")]public string OnCompleteScript
					{
						get
						{
