	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </summary>
				/// <remarks></remarks>
				[ToolboxItem(typeof(System.Web.UI.Design.WebControlToolboxItem)), ToolboxBitmapAttribute(typeof(System.Web.UI.WebControls.CheckBoxList), "CheckBoxList.bmp"), ToolboxData("<{0}:CheckBoxList runat=server></{0}:CheckBoxList>"), ParseChildren(true, "Items"), PersistChildren(false, false)]public class CheckBoxList : System.Web.UI.WebControls.CheckBoxList
				{
					
					[Category("Behavior"), Description("Determines the action that special itens will perform"), DefaultValue(typeof(CheckBoxSpecialItemAction), "SelectAndUnSelectAll")]public CheckBoxSpecialItemAction SpecialItemAction
					{
						get
						{
					...
					[Browsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Behavior"), Description("Determines whether to display the special item on the list"), DefaultValue(typeof(CheckBoxSpecialItemPosition), "Bottom")]public CheckBoxSpecialItemPosition SpecialItemPosition
					{
						get
						{
					...
					[Category("Appearance"), Description("Gets or sets the text to show on special items"), DefaultValue(typeof(CheckBoxSpecialItemPosition), "(Un)Select All")]public string SpecialItemText
					{
						get
						{
