	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// <remarks>
				/// </remarks>
				[ToolboxItem(typeof(System.Web.UI.Design.WebControlToolboxItem)), ToolboxData("<{0}:PreviewImage runat=\"server\" />"), ToolboxBitmapAttribute(typeof(System.Web.UI.WebControls.Image), "Image.bmp")]public class PreviewImage : System.Web.UI.WebControls.Image
				{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), DefaultValue(70), Category("Appearance"), Description("The transparency level. From 0 to 100 (percentage)")]public int TransparencyLevel
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), DefaultValue(typeof(Color), "Black"), Category("Appearance"), Description("The transparency color.")]public System.Drawing.Color TransparencyColor
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), UrlProperty("*.bmp;*.jpg;*.png;*.tif;*.gif"), Editor(typeof(System.Web.UI.Design.UrlEditor), typeof(System.Drawing.Design.UITypeEditor)), DefaultValue(""), Category("Appearance"), Description("The URL of a Full Sized image.")]public string FullSizedImageUrl
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), DefaultValue(typeof(PreviewImageLoadingAnimation), "Gray"), Category("Appearance"), Description("Specifies one of the LoadingAnimation to show.")]public PreviewImageLoadingAnimation LoadingAnimation
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), DefaultValue(""), Category("Appearance"), Description("The text to show below the image.")]public string Description
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Themeable(true), DefaultValue(false), Category("Behavior"), Description("Determines whether to hide \'object\' tags when showing image.")]public bool HideObjects
					{
						get
						{
