	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				[TypeConverterAttribute(typeof(ExpandableObjectConverter))][AspNetHostingPermissionAttribute(SecurityAction.LinkDemand, Level = AspNetHostingPermissionLevel.Minimal)]public class PagerSettings : IStateManager
				{
					...
					[CategoryAttribute("Appearance")][NotifyParentPropertyAttribute(true)][UrlPropertyAttribute()][DefaultValueAttribute("")][EditorAttribute("System.Web.UI.Design.ImageUrlEditor, System.Design", "System.Drawing.Design.UITypeEditor, System.Drawing")]public string FirstPageImageUrl
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][DefaultValueAttribute("<<")][NotifyParentPropertyAttribute(true)]public string FirstPageText
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][NotifyParentPropertyAttribute(true)][UrlPropertyAttribute()][DefaultValueAttribute("")][EditorAttribute("System.Web.UI.Design.ImageUrlEditor, System.Design", "System.Drawing.Design.UITypeEditor, System.Drawing")]public string LastPageImageUrl
					{
						get
						{
					...
					[NotifyParentPropertyAttribute(true)][CategoryAttribute("Appearance")][DefaultValueAttribute(">>")]public string LastPageText
					{
						get
						{
					...
					[NotifyParentPropertyAttribute(true)][CategoryAttribute("Appearance")][DefaultValueAttribute(PagerButtons.Numeric)]public PagerButtons Mode
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][NotifyParentPropertyAttribute(true)][UrlPropertyAttribute()][DefaultValueAttribute("")][EditorAttribute("System.Web.UI.Design.ImageUrlEditor, System.Design", "System.Drawing.Design.UITypeEditor, System.Drawing")]public string NextPageImageUrl
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][NotifyParentPropertyAttribute(true)][DefaultValueAttribute(">")]public string NextPageText
					{
						get
						{
					...
					[CategoryAttribute("Behavior")][NotifyParentPropertyAttribute(true)][DefaultValueAttribute(10)]public int PageButtonCount
					{
						get
						{
					...
					[CategoryAttribute("Layout")][DefaultValueAttribute(PagerPosition.Bottom)][NotifyParentPropertyAttribute(true)]public PagerPosition Position
					{
						get
						{
					...
					[CategoryAttribute("Layout")][DefaultValueAttribute("")][IDReferenceProperty()][NotifyParentPropertyAttribute(true)]public string FirstPagerContainer
					{
						get
						{
					...
					[CategoryAttribute("Layout")][DefaultValueAttribute("")][IDReferenceProperty()][NotifyParentPropertyAttribute(true)]public string SecondPagerContainer
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][NotifyParentPropertyAttribute(true)][UrlPropertyAttribute()][DefaultValueAttribute("")][EditorAttribute("System.Web.UI.Design.ImageUrlEditor, System.Design", "System.Drawing.Design.UITypeEditor, System.Drawing")]public string PreviousPageImageUrl
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][DefaultValueAttribute("<")][NotifyParentPropertyAttribute(true)]public string PreviousPageText
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][DefaultValueAttribute("|")][NotifyParentPropertyAttribute(true)]public string Separator
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][DefaultValueAttribute("")][NotifyParentPropertyAttribute(true)]public string ContainerCssClass
					{
						get
						{
					...
					[CategoryAttribute("Appearance")][DefaultValueAttribute(true)][NotifyParentPropertyAttribute(true)]public bool Visible
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[Category("Paging"), Description("The number of rows to display per page"), DefaultValue(5)]public int PageSize
					{
						get
						{
					...
					[CategoryAttribute("Behavior")][DefaultValueAttribute(true)][NotifyParentPropertyAttribute(true)]public bool UseQueryString
					{
						get
						{
					...
					[CategoryAttribute("Behavior")][DefaultValueAttribute("PageIndex")][NotifyParentPropertyAttribute(true)]public string QueryStringKey
					{
						get
						{
