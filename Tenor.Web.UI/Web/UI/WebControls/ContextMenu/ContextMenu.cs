	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </summary>
				/// <remarks></remarks>
				[ToolboxData("<{0}:ContextMenu runat=server></{0}:ContextMenu>")]public class ContextMenu : ListControl, IPostBackEventHandler
				{
					...
					#region " Associacao "
					[Themeable(false), TypeConverter(typeof(AssociatedControlConverter)), Category("Behavior"), IDReferenceProperty(), DefaultValue(""), Description("The control that will handle this context menu.")]public virtual string AssociatedControlID
					{
						get
						{
					...
					#region " Desativados "
					[Bindable(false), EditorBrowsable(EditorBrowsableState.Never)]public override int SelectedIndex
					{
						get
						{
					...
					[EditorBrowsable(EditorBrowsableState.Never)]public override ListItem SelectedItem
					{
						get
						{
					...
					[EditorBrowsable(EditorBrowsableState.Never), Bindable(false)]public override string SelectedValue
					{
						get
						{
					...
					[EditorBrowsable(EditorBrowsableState.Never)]public override string @Text
					{
						get
						{
							return base.Text;
					...
					[Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]public override bool AutoPostBack
					{
						get
						{
					...
					#region " Eventos "
					[Description("Handles the click event"), Category("Action")]private ContextMenuEventHandler ClickEvent;
				...
				[AspNetHostingPermission(SecurityAction.InheritanceDemand, Level = AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level = AspNetHostingPermissionLevel.Minimal)]public class ContextMenuEventArgs : EventArgs
				{
