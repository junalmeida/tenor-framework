...
namespace Tenor.Web.UI.WebControls
{
    ...
    public class TabsMultiView : MultiView
    {
        ...
        [TypeConverter(typeof(WebColorConverter)), DefaultValue(typeof(Color), ""), Category("Appearance"), Description("WebControl_BackColor")]
        ...
        [Category("Appearance"), Description("WebControl_BorderColor"), DefaultValue(typeof(Color), ""), TypeConverter(typeof(WebColorConverter))]
        ...
        [DefaultValue(0), Category("Appearance"), Description("WebControl_BorderStyle")]
        ...
        [Description("WebControl_BorderWidth"), Category("Appearance"), DefaultValue(typeof(Unit), "")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Description("WebControl_ControlStyle")]
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced), Browsable(false), Description("WebControl_ControlStyleCreated"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Description("WebControl_CSSClassName"), DefaultValue(""), Category("Appearance")]
        ...
        [Description("WebControl_Font"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), Category("Appearance")]
        ...
        [Description("WebControl_ForeColor"), TypeConverter(typeof(WebColorConverter)), Category("Appearance"), DefaultValue(typeof(Color), "")]
        ...
        [Category("Layout"), DefaultValue(typeof(Unit), ""), Description("WebControl_Width")]
        ...
        [Description("WebControl_Height"), Category("Layout"), DefaultValue(typeof(Unit), "")]
        ...
        [Description(""), DefaultValue(1), Category("Behavior")]
        public virtual BulletedListDisplayMode TabDisplayMode
        {
            get
            {
        ...
        public virtual System.Drawing.Color TabBackColor
        {
            get
            {
    ...
    public class TabView : View
    {
        ...
        [Description("The tab title of this view"), Category("Appearance")]
        public string Title
        {
            get
            {
        ...
        [Description("Controls when to show this TabView"), Category("Behavior"), DefaultValue(true)]
