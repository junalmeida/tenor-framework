...
namespace Tenor.Web.UI.WebControls.Adapters
{
    ...
    internal class WebControlAdapterExtender
    {
        ...
        public bool AdapterEnabled
        {
            get
            {
                ...
                if ((AdaptedControl != null) && (!string.IsNullOrEmpty(AdaptedControl.Attributes["AdapterEnabled"])) && (AdaptedControl.Attributes["AdapterEnabled"].IndexOf("false", StringComparison.OrdinalIgnoreCase) == 0))
                {
                    bReturn = false;
                }
        ...
        public bool AutoAccessKey
        {
            get
            {
                ...
                if (_disableAutoAccessKey || ((AdaptedControl != null) && (!string.IsNullOrEmpty(AdaptedControl.Attributes["AutoAccessKey"])) && (AdaptedControl.Attributes["AutoAccessKey"].IndexOf("false", StringComparison.OrdinalIgnoreCase) == 0)))
                {
                    bReturn = false;
                }
        ...
        {
            this.AdaptedControl.Page.ClientScript.RegisterClientScriptResource(this.GetType(), Configuration.Resources.JsAdapterUtils);
        }
        ...
        public void WriteTextBox(HtmlTextWriter writer, bool isPassword, string labelClassName, string labelText, string inputClassName, string id, string value)
        {
            ...
            writer.WriteAttribute("type", (isPassword ? "password" : "text").ToString());
    ...
    internal class ControlRestorationInfo
    {
