	...
	namespace Web
	{
		namespace UI
		{
			namespace WebControls
			{
				...
				/// </remarks>
				[ToolboxItem(typeof(System.Web.UI.Design.WebControlToolboxItem)), ToolboxData("<{0}:TextBox runat=\"server\" />"), ToolboxBitmapAttribute(typeof(System.Web.UI.WebControls.TextBox), "TextBox.bmp")]public class TextBox : System.Web.UI.WebControls.TextBox
				{
					...
					[Description("The behavior mode of the TextBox"), Category("Behavior"), DefaultValue(typeof(TextBoxMode), "SingleLine")]public TextBoxMode TextBoxMode
					{
						get
						{
					...
					/// </list>
					/// </remarks>
					[DefaultValue(""), Description("Gets or sets the mask to apply when Mask is set to Custom."), Category("Behavior")]public string CustomMask
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[DefaultValue(""), Description("Gets or sets the regular expression validation rule to apply when Mask is set to Custom."), Category("Behavior")]public string CustomValidation
					{
						get
						{
					...
					/// <returns></returns>
					/// <remarks></remarks>
					[DefaultValue("Gets or sets the error message to display in case of unsuccesful validation."), Description("Gets or sets the error message to display in case of unsuccesful validation."), Category("Behavior")]public string ErrorMessage
					{
						get
						{
					...
					/// <value></value>
					/// <returns></returns>
					[Themeable(true), DefaultValue(typeof(TextBoxCalendarButton), "None"), Description("Indicates whether to show a glyph with a calendar pane. This property is valid only if TextBoxMode is set to any Date format."), Category("Appearance")]public TextBoxCalendarButton ShowCalendar
					{
						get
						{
