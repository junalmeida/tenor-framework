...
namespace Tenor.Web.UI.WebControls
{
    ...
    public class SlidingPanel : System.Web.UI.WebControls.CompositeDataBoundControl, IPostBackDataHandler
    {
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Description(" Items")]
        public virtual SlidingPanelItemCollection Items
        {
            get
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), Description(""), Category("Style")]
        ...
        [Browsable(false), TemplateContainer(typeof(SlidingPanelItem)), PersistenceMode(PersistenceMode.InnerProperty), Description(""), Category("Style")]
        ...
        [Browsable(false), TemplateContainer(typeof(SlidingPanelItem)), PersistenceMode(PersistenceMode.InnerProperty), Description(""), Category("Style")]
        public ITemplate LeftSlidingTemplate
        {
            get
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), Description(""), Category("Style")]
        public Style RightSlidingStyle
        {
            get
            {
        ...
        [Browsable(false), TemplateContainer(typeof(SlidingPanelItem)), PersistenceMode(PersistenceMode.InnerProperty), Description(""), Category("Style")]
        public ITemplate RightSlidingTemplate
        {
            get
            {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        [Description("Determines the orientation of the SlidingPanel"), Category("Layout"), DefaultValue(typeof(Orientation), "Horizontal")]
