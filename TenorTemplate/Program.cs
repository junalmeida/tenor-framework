    ...
    static class Program
    {
        ...
        public static DriverData[] CustomConnections
        {
            get
            {
                ...
                list.Add(new DriverData(MyMeta.dbDriver.MySql2, "MySQL", "server={0};database={1};user Id={2};password={3}"));
                list.Add(new DriverData(MyMeta.dbDriver.SQLite, "SQLite", "Data Source=\"{0}\";"));
                /*
